    ...
    <div className="text-center text-2xl pt-10 border-t" >
     ...
     <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28" >
       ...
       <div className="flex flex-col justify-center items-start gap-6" >
        ...
        <p className="text-gray-500" >8458 Gas Station <br/> Aurai 210, Varanasi, India </p>
        <p className="text-gray-500" >Tel: (91) 9876543210 <br/> Email: admin@wear.com </p>
        <p className="font-semibold text-xl text-gray-600" >Carrers at Wear</p>
